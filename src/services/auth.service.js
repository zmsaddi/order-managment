...
// هذا سيمنع تداخل الجلسات عند إنشاء مستخدمين جدد
...
export const authService = {
  ...
  async createUser(userData) {
    ...
    try {
      ...
      // هذا سيمنع تأثير عملية إنشاء المستخدم على جلسة المستخدم الحالي
      ...
      // استخدام adminSupabase هنا أيضاً للاتساق
  ...
  async resetPassword(userId, newPassword) {
    ...
    // إعادة تعيين كلمة المرور باستخدام adminSupabase
  ...
  async updateUserPassword(userId, newPassword) {
    ...
    try {
      // تحديث كلمة المرور باستخدام adminSupabase
      const { error } = await adminSupabase.auth.admin.updateUserById(
        userId,
        { password: newPassword }
      )
