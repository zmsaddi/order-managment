          ...
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
              <div class="mt-3 text-center sm:mt-0 sm:mr-4 sm:text-right w-full">
                ...
                <div class="mt-4">
                  <form @submit.prevent="addUserDirectly">
                    <div class="mb-4">
          ...
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
              <div class="mt-3 text-center sm:mt-0 sm:mr-4 sm:text-right w-full">
                ...
                <div class="mt-4">
                  <form @submit.prevent="updateUserDirectly">
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                      ...
                      <select 
                        ...
                        class="form-input" 
                        required
                        :disabled="editingUser.role === 'admin' && user.role !== 'admin'"
                      >
                        <option value="admin">مدير</option>
                        <option value="sales_manager">مدير مبيعات</option>
                        <option value="sales_rep">مندوب مبيعات</option>
                    ...
                    <div class="mb-4">
                      <label for="edit-status" class="form-label">الحالة <span class="text-red-500">*</span></label>
                      <select 
                        id="edit-status" 
                    ...
                    <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                      <button 
                        ...
                        :disabled="submitting"
                      >
                        <span v-if="submitting">جاري التحديث...</span>
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-right overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              ...
              <div class="mt-3 text-center sm:mt-0 sm:mr-4 sm:text-right">
                ...
                <div class="mt-2">
                  <p class="text-sm text-gray-500">
                    هل أنت متأكد من رغبتك في حذف المستخدم "{{ userToDelete?.name }}"؟ هذا الإجراء لا يمكن التراجع عنه.
                  </p>
                </div>
              </div>
            </div>
            <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
              <button 
                type="button" 
                class="btn bg-red-600 text-white hover:bg-red-700 focus:ring-red-500 w-full sm:w-auto sm:mr-3" 
                @click="deleteUserDirectly"
                :disabled="deleting"
              >
